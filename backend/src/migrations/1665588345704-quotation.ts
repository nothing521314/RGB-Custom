...
export class quotation1665588345704 implements MigrationInterface {
    name = 'quotation1665588345704'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "qoutation" ("id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "sale_persion_id" character varying, "title" character varying NOT NULL, "code" character varying NOT NULL, "date" date, "customer_id" character varying, "region_id" character varying, "heading" text, "condition" text, "payment_term" text, "delivery_lead_time" date, "warranty" text, "install_support" text, "appendix_a" text, "appendix_b" text, CONSTRAINT "PK_43fc75caf179d7e934e0fa996e9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_fb90577bc2e139570618825658" ON "qoutation" ("sale_persion_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_fe8c075d370ab5ebedb9a15675" ON "qoutation" ("customer_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_7c412e5e8e534d2215f242ab36" ON "qoutation" ("region_id") `);
        await queryRunner.query(`CREATE TABLE "qoutation_line" ("id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "product_id" character varying NOT NULL, "qoutation_id" character varying NOT NULL, "volume" integer NOT NULL, "unit_price" integer NOT NULL, "parent_product_id" character varying NOT NULL, CONSTRAINT "PK_d6d36c2481f3d260e37f1beb43c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_959b7726aaaf9b602aa41f118f" ON "qoutation_line" ("product_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_5aa244fa41696a1e58cd41bb28" ON "qoutation_line" ("qoutation_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_6361511fb3dcc1324127bff788" ON "qoutation_line" ("parent_product_id") `);
        await queryRunner.query(`ALTER TABLE "product" DROP COLUMN "additional_hardware_ids"`);
        await queryRunner.query(`ALTER TABLE "product" DROP COLUMN "price_ids"`);
        ...
        await queryRunner.query(`ALTER TABLE "qoutation" ADD CONSTRAINT "FK_fb90577bc2e139570618825658f" FOREIGN KEY ("sale_persion_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "qoutation" ADD CONSTRAINT "FK_fe8c075d370ab5ebedb9a156754" FOREIGN KEY ("customer_id") REFERENCES "customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "qoutation" ADD CONSTRAINT "FK_7c412e5e8e534d2215f242ab361" FOREIGN KEY ("region_id") REFERENCES "region"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "qoutation_line" ADD CONSTRAINT "FK_959b7726aaaf9b602aa41f118f7" FOREIGN KEY ("product_id") REFERENCES "product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "qoutation_line" ADD CONSTRAINT "FK_5aa244fa41696a1e58cd41bb286" FOREIGN KEY ("qoutation_id") REFERENCES "qoutation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "qoutation_line" ADD CONSTRAINT "FK_6361511fb3dcc1324127bff7887" FOREIGN KEY ("parent_product_id") REFERENCES "qoutation_line"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "qoutation_line" DROP CONSTRAINT "FK_6361511fb3dcc1324127bff7887"`);
        await queryRunner.query(`ALTER TABLE "qoutation_line" DROP CONSTRAINT "FK_5aa244fa41696a1e58cd41bb286"`);
        await queryRunner.query(`ALTER TABLE "qoutation_line" DROP CONSTRAINT "FK_959b7726aaaf9b602aa41f118f7"`);
        await queryRunner.query(`ALTER TABLE "qoutation" DROP CONSTRAINT "FK_7c412e5e8e534d2215f242ab361"`);
        await queryRunner.query(`ALTER TABLE "qoutation" DROP CONSTRAINT "FK_fe8c075d370ab5ebedb9a156754"`);
        await queryRunner.query(`ALTER TABLE "qoutation" DROP CONSTRAINT "FK_fb90577bc2e139570618825658f"`);
        await queryRunner.query(`ALTER TABLE "shipping_tax_rate" DROP CONSTRAINT "FK_346e0016cf045b9980747747645"`);
        await queryRunner.query(`ALTER TABLE "shipping_tax_rate" DROP CONSTRAINT "FK_f672727ab020df6c50fb64c1a70"`);
        await queryRunner.query(`ALTER TABLE "product_type_tax_rate" DROP CONSTRAINT "FK_ece65a774192b34253abc4cd672"`);
        await queryRunner.query(`ALTER TABLE "product_type_tax_rate" DROP CONSTRAINT "FK_25a3138bb236f63d9bb6c8ff111"`);
        ...
        await queryRunner.query(`ALTER TABLE "discount_condition_product" ADD "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "discount_condition_product" ADD "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "product" ADD "price_ids" text`);
        await queryRunner.query(`ALTER TABLE "product" ADD "additional_hardware_ids" text`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6361511fb3dcc1324127bff788"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5aa244fa41696a1e58cd41bb28"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_959b7726aaaf9b602aa41f118f"`);
        await queryRunner.query(`DROP TABLE "qoutation_line"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_7c412e5e8e534d2215f242ab36"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_fe8c075d370ab5ebedb9a15675"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_fb90577bc2e139570618825658"`);
        await queryRunner.query(`DROP TABLE "qoutation"`);
        await queryRunner.query(`CREATE INDEX "IDX_f672727ab020df6c50fb64c1a7" ON "shipping_tax_rate" ("shipping_option_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_346e0016cf045b998074774764" ON "shipping_tax_rate" ("rate_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_25a3138bb236f63d9bb6c8ff11" ON "product_type_tax_rate" ("product_type_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_ece65a774192b34253abc4cd67" ON "product_type_tax_rate" ("rate_id") `);
