...
export class updateUser1665296797178 implements MigrationInterface {
    name = 'updateUser1665296797178'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "role" SET DEFAULT 'sale_man'`);
        ...
        await queryRunner.query(`ALTER TABLE "invite" ALTER COLUMN "role" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "invite" ALTER COLUMN "role" TYPE "public"."invite_role_enum" USING "role"::"text"::"public"."invite_role_enum"`);
        await queryRunner.query(`ALTER TABLE "invite" ALTER COLUMN "role" SET DEFAULT 'sale_man'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_c759f53b2e48e8cfb50638fe4e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f05132301e95bdab4ba1cf29a2"`);
        await queryRunner.query(`CREATE TYPE "public"."invite_role_enum_old" AS ENUM('admin', 'member', 'developer')`);
        await queryRunner.query(`ALTER TABLE "invite" ALTER COLUMN "role" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "invite" ALTER COLUMN "role" SET DEFAULT 'member'`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_role_enum_old" AS ENUM('admin', 'member', 'developer')`);
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "role" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "role" TYPE "public"."user_role_enum_old" USING "role"::"text"::"public"."user_role_enum_old"`);
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "role" SET DEFAULT 'member'`);
