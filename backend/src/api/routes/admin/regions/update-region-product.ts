...
export default async (req, res) => {
  const { region_id, product_id } = req.params
  const validated = await validator(AdminPriceRegionReq, req.body)
  ...
  await manager.transaction(async (transactionManager) => {
    return await regionService
      ...
      .updateProduct(region_id, product_id, validated.price)
  })
...
export class AdminPriceRegionReq {
  @IsNumber()
  @IsOptional()
  price: number
